...
import net.minecraftforge.gradle.util.pack200.ConstantPool.Entry;
...
import net.minecraftforge.gradle.util.pack200.Package.Class;
import net.minecraftforge.gradle.util.pack200.Package.InnerClass;
