...
import net.minecraftforge.gradle.util.pack200.ConstantPool.ClassEntry;
import net.minecraftforge.gradle.util.pack200.ConstantPool.DescriptorEntry;
import net.minecraftforge.gradle.util.pack200.ConstantPool.LiteralEntry;
import net.minecraftforge.gradle.util.pack200.ConstantPool.MemberEntry;
import net.minecraftforge.gradle.util.pack200.ConstantPool.MethodHandleEntry;
import net.minecraftforge.gradle.util.pack200.ConstantPool.MethodTypeEntry;
import net.minecraftforge.gradle.util.pack200.ConstantPool.InvokeDynamicEntry;
import net.minecraftforge.gradle.util.pack200.ConstantPool.BootstrapMethodEntry;
import net.minecraftforge.gradle.util.pack200.ConstantPool.SignatureEntry;
import net.minecraftforge.gradle.util.pack200.ConstantPool.Utf8Entry;
